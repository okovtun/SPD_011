...
public:
	...
	void set_speciality(const string& speciality)
	{
		...
		else if (speciality.empty() == true) cout << "Специальность не может быть пуста, повторите ввод..." << endl;
		else if (speciality.length() > 50) cout << "Специальность слишком длинная, повторите ввод..." << endl;
	}
	void set_experience(unsigned int experience)
	{
		if (experience >= 0 && experience <= 80) this->experience = experience;
		else cout << "Стаж выходит за пределы допустимого, повторите ввод..." << endl;
	}
	Teacher
	(
	...
	{
		Human::info();
		cout << speciality << " стаж " << experience << " лет." << endl;
	}
	void duty()
	{
...
*/
	...
	//regex_match(наша_строка, регулярное_выражение, шаблон_проверки);
	...
	Human* group[] =
	{
		...
		new Graduate("Кудратов", "Шахзод", 18, "РПО", "SPD_011", 98, "Разработка искуственного интеллекта")
	};
